...
const translations = {
  en: {
    ...
    'about.who.p2': 'Founded by professionals with deep experience in both Chinese and American markets, we specialize in translating global innovation into local success.',
    ...
    'about.leadership.desc': 'Jon Li is a product of Detroit and North Carolina. He has over 15 years of experience spanning both the U.S. and China. He combines deep product expertise with cross-cultural insight.',
    ...
    'services.hero.subtitle': 'Strategic guidance to help Chinese consumer electronics brands succeed in the U.S. market.',
    ...
    'services.gtm.title': 'Go-to-Market & Sales Enablement',
    ...
    'contact.why.focus.desc': 'We exclusively help Chinese consumer electronics brands succeed in the U.S. market.',
    'contact.why.expertise.title': 'Cross-Cultural Expertise',
    'contact.why.expertise.desc': 'Our bicultural team understands both Chinese and American business environments.',
  ...
  zh: {
    ...
    'about.leadership.desc': 'Jon Li来自底特律和北卡罗来纳州。他拥有超过15年跨越美国和中国的经验。他将深厚的产品专业知识与跨文化洞察相结合。',
    ...
    'services.hero.subtitle': '为中国消费电子品牌在美国市场取得成功提供战略指导。',
    ...
    'contact.why.focus.desc': '我们专门帮助中国消费电子品牌在美国市场取得成功。',
