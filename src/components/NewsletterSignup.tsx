...
const NewsletterSignup = ({
  ...
  description = 'A regular read on where Humans and AI converge. Discover the new companies, shifting categories and what it means for product and market strategy.',
  compact = false,
  wide = false,
