...
export function useTeam() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (error) throw error;
      return data as unknown as { id: string; user_id: string | null; role: string; email: string | null; name: string | null; phone: string | null; photo_url: string | null; is_active: boolean }[];
    },
  });
}
