...
// Category-based fallback images so each card looks relevant when scraped perks don't include their own image.
...
function categoryImage(category: string, ...seedParts: (string | null | undefined)[]): string {
