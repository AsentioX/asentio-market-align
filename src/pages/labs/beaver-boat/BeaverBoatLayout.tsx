    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <footer className="bg-black text-white/60 py-10 text-center text-sm">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 mt-4 text-white/60 hover:text-[#FF000D] transition"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772 4.902 4.902 0 011.772-1.153c.636-.247 1.363-.416 2.427-.465 1.067-.047 1.407-.06 3.808-.06h.63zm3.375 2.25c-2.556 0-2.864.011-3.871.054-.976.042-1.505.203-1.858.343-.466.182-.8.398-1.15.748-.35.35-.566.684-.748 1.15-.14.353-.3.882-.343 1.858-.043 1.007-.054 1.315-.054 3.871 0 2.556.011 2.864.054 3.871.042.976.203 1.505.343 1.858.182.466.399.8.748 1.15.35.35.684.566 1.15.748.353.14.882.3 1.858.343 1.007.043 1.315.054 3.871.054 2.556 0 2.864-.011 3.871-.054.976-.042 1.505-.203 1.858-.343.466-.182.8-.398 1.15-.748.35-.35.566-.684.748-1.15.14-.353.3-.882.343-1.858.043-1.007.054-1.315.054-3.871 0-2.556-.011-2.864-.054-3.871-.042-.976-.203-1.505-.343-1.858-.182-.466-.399-.8-.748-1.15-.35-.35-.684-.566-1.15-.748-.353-.14-.882-.3-1.858-.343-1.007-.043-1.315-.054-3.871-.054zm-3.375 3.063a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 8.468a3.333 3.333 0 100-6.666 3.333 3.333 0 000 6.666zm6.538-8.671a1.2 1.2 0 11-2.4 0 1.2 1.2 0 012.4 0z" />
          </svg>
          <span className="font-bold">@beaverboatclub</span>
        </a>
      </footer>
