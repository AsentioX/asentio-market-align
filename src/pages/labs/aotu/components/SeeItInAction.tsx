        ...
        <div className="grid md:grid-cols-3 gap-4">
          {clips.map((c) => {
            ...
            return (
              <div
                key={c.title}
                className="group relative aspect-[4/5] rounded-2xl overflow-hidden bg-gradient-to-br from-white/[0.06] to-white/[0.02] border border-white/10 hover:border-[#00B8FF]/50 transition-all cursor-pointer"
              >
                <div className="absolute inset-0">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "linear-gradient(rgba(0,184,255,0.18) 1px, transparent 1px), linear-gradient(90deg, rgba(0,184,255,0.18) 1px, transparent 1px)",
                      backgroundSize: "32px 32px",
                    }}
                  />
                  <div className="absolute top-1/3 left-1/4 w-1/3 h-1/4 border-2 border-[#00B8FF] rounded-sm">
                    <div className="absolute -top-5 left-0 text-[10px] font-semibold text-[#0A0F1C] bg-[#00B8FF] px-1.5 py-0.5 rounded-sm">
                      0.92
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-14 h-14 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center group-hover:bg-[#00B8FF] group-hover:border-[#00B8FF] transition-all">
                ...
                <div className="absolute bottom-0 inset-x-0 p-5 bg-gradient-to-t from-[#0A0F1C] via-[#0A0F1C]/70 to-transparent">
                  <div className="flex items-start gap-3">
                    <Icon className="w-4 h-4 text-[#00B8FF] mt-0.5 shrink-0" />
                    <div>
                      <div
