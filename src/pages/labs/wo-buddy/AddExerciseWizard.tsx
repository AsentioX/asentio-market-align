        ...
        <div className="flex items-center gap-1.5">
          {STEPS.map(s => (
            <div key={s.id} className="flex-1">
              ...
              />
              <div className={`text-[9px] mt-1 text-center font-medium ${s.id === step ? 'text-emerald-300' : 'text-stone-900/30'}`}>
                {s.label}
              </div>
            </div>
          ))}
      ...
      {step === 1 && (
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-stone-900/40 mt-0.5">The basics help us file it correctly.</p>
          </div>
          ...
          <Field label="Exercise name" required error={errors.name}>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-stone-900/[0.05] border border-stone-900/10 rounded-xl px-3 py-2.5 text-sm text-stone-900 placeholder:text-stone-900/25 focus:outline-none focus:border-emerald-500/40"
                maxLength={80}
              />
              <input
                type="text"
              ...
              {DIFFICULTY_OPTIONS.map(opt => (
                <button
                  ...
                  className={`py-2 rounded-xl border text-[11px] font-medium transition-all ${
                    difficulty === opt.value ? opt.color : 'bg-stone-900/[0.04] border-stone-900/10 text-stone-900/40'
                  }`}
                >
                  {opt.label}
                </button>
          ...
          <Field label="Description (optional)">
            <textarea
              ...
              rows={2}
              maxLength={240}
              className="w-full bg-stone-900/[0.05] border border-stone-900/10 rounded-xl px-3 py-2.5 text-sm text-stone-900 placeholder:text-stone-900/25 focus:outline-none focus:border-emerald-500/40 resize-none"
            />
          </Field>
          ...
          <Field label="Equipment needed (optional)">
            <input
              ...
              maxLength={120}
              className="w-full bg-stone-900/[0.05] border border-stone-900/10 rounded-xl px-3 py-2.5 text-sm text-stone-900 placeholder:text-stone-900/25 focus:outline-none focus:border-emerald-500/40"
            />
          </Field>
        </div>
      )}
      ...
      {step === 2 && (
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-stone-900/40 mt-0.5">Drivers connect this exercise to your goals.</p>
          </div>
          ...
          {drivers.length > 0 && (
            <div className="space-y-2.5">
              <div className="text-[10px] font-semibold uppercase tracking-widest text-stone-900/40">
                Tune each driver
              </div>
              {drivers.map(d => {
                  ...
                  <div key={d.driver} className="rounded-xl border border-stone-900/10 bg-stone-900/[0.04] p-3 space-y-2.5">
                      ...
                      <button
                        ...
                        className={`text-[10px] px-2 py-0.5 rounded-full font-medium transition-colors ${
                          d.isPrimary
                            ...
                            : 'bg-stone-900/5 text-stone-900/40 border border-stone-900/10 hover:text-stone-900/70'
                        }`}
                      >
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-[10px] uppercase tracking-wider text-stone-900/40">Contribution</span>
                    ...
                    <input
                      ...
                      maxLength={140}
                      className="w-full bg-stone-900/[0.05] border border-stone-900/10 rounded-lg px-2.5 py-1.5 text-[11px] text-stone-900 placeholder:text-stone-900/25 focus:outline-none focus:border-emerald-500/30"
                    />
                  </div>
                );
              })}
      ...
      {step === 3 && (
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-stone-900/40 mt-0.5">Pick a preset or add metrics yourself.</p>
          </div>
          ...
          <div className="rounded-xl border border-emerald-500/15 bg-gradient-to-br from-emerald-500/[0.06] to-stone-900/[0.03] p-3 space-y-2">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] font-semibold uppercase tracking-widest text-stone-900/50">Quick presets</span>
            </div>
            <div className="grid grid-cols-2 gap-1.5">
          ...
          <div className="space-y-2">
              ...
              <div key={m.id} className="rounded-xl border border-stone-900/10 bg-stone-900/[0.04] p-2.5 space-y-2">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 bg-stone-900/[0.05] border border-stone-900/10 rounded-lg px-2.5 py-1.5 text-xs text-stone-900 placeholder:text-stone-900/25 focus:outline-none focus:border-emerald-500/30"
                  />
                  <button
                    onClick={() => removeMetric(m.id)}
                    className="w-7 h-7 flex items-center justify-center rounded-lg text-stone-900/30 hover:text-red-400 hover:bg-red-500/10"
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  ...
                  <input
                    ...
                    placeholder="Unit"
                    className="col-span-1 bg-stone-900/[0.05] border border-stone-900/10 rounded-lg px-2 py-1.5 text-[11px] text-stone-900 placeholder:text-stone-900/25 focus:outline-none focus:border-emerald-500/30"
                  />
                  <button
                    ...
                    className={`col-span-1 rounded-lg px-2 py-1.5 text-[10px] font-medium border transition-all ${
                      m.required
                        ...
                        : 'bg-stone-900/[0.05] border-stone-900/10 text-stone-900/40'
                    }`}
                  >
            ...
            <button
              onClick={() => addMetric()}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-dashed border-stone-900/15 text-xs text-stone-900/50 hover:text-emerald-300 hover:border-emerald-500/40 transition-all"
            >
      ...
      {step === 4 && (
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-stone-900/40 mt-0.5">Optional — tells us why this exercise matters to you.</p>
          </div>

          {goals.length === 0 ? (
            <div className="rounded-xl border border-stone-900/10 bg-stone-900/[0.04] p-5 text-center space-y-2">
              <Target className="w-5 h-5 text-stone-900/30 mx-auto" />
              <p className="text-xs text-stone-900/50">No active goals yet.</p>
              <p className="text-[11px] text-stone-900/30">Add a goal in the Goals tab to link exercises.</p>
            </div>
          ) : (
            <div className="space-y-2">
              {goals.map(g => {
                ...
                return (
                  <div key={g.id} className={`rounded-xl border transition-all ${selected ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-stone-900/[0.04] border-stone-900/10'}`}>
                    ...
                    >
                      ...
                      <Target className="w-3.5 h-3.5 text-stone-900/40" />
      ...
      {step === 5 && (
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-stone-900/40 mt-0.5">Review and add to your workout.</p>
          </div>
          ...
          <div className="rounded-2xl border border-stone-900/10 bg-gradient-to-br from-stone-900/[0.05] to-stone-900/[0.03] p-4 space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-stone-900/5 text-stone-900/50 capitalize">{category}</span>
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-stone-900/5 text-stone-900/50 capitalize">{difficulty}</span>
                </div>
              </div>
            </div>

            {description && <p className="text-xs text-stone-900/50 leading-relaxed">{description}</p>}

            <Section title="Drivers">
              <div className="flex flex-wrap gap-1.5">
                {drivers.map(d => (
                  <span key={d.driver} className={`text-[10px] px-2 py-0.5 rounded-full border ${
                    d.isPrimary ? 'bg-amber-500/15 text-amber-300 border-amber-500/30' : 'bg-stone-900/5 text-stone-900/60 border-stone-900/10'
                  }`}>
            ...
            <Section title="Metrics">
              <div className="flex flex-wrap gap-1.5">
                {metrics.map(m => (
                  <span key={m.id} className="text-[10px] px-2 py-0.5 rounded-full bg-stone-900/5 text-stone-900/60 border border-stone-900/10">
            ...
            <div className="rounded-xl bg-amber-500/[0.06] border border-amber-500/15 p-3 space-y-1">
              ...
              <p className="text-[11px] text-stone-900/60 leading-relaxed">
                {drivers.length
...
const Field = ({
  ...
  <div className="space-y-1.5">
    <div className="flex items-center justify-between">
      <span className="text-[10px] font-semibold uppercase tracking-widest text-stone-900/50">
...
const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="space-y-1.5">
    <div className="text-[10px] font-semibold uppercase tracking-widest text-stone-900/40">{title}</div>
    {children}
  </div>
);
