...
const ResidentialAutonomy = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xs uppercase tracking-[0.18em] text-stone-500 font-semibold mb-2">Autonomy · rule builder</h2>
        <p className="text-[17px] text-stone-700 leading-snug">Your home acts on rules of the form <span className="text-stone-900 font-semibold">IF (person + condition + space) THEN (action)</span>.</p>
      </div>
      ...
      <div className="relative rounded-3xl border border-violet-200 bg-gradient-to-br from-violet-50 via-indigo-50 to-white p-5 flex items-start gap-4 overflow-hidden">
        ...
        <div className="relative flex-1">
          <div className="text-base font-semibold text-stone-900">X1 is learning your behavior patterns</div>
          <div className="text-[13px] text-stone-600 mt-1 leading-relaxed">
            <span className="font-semibold text-violet-700">23 patterns</span> identified from the last 30 days · <span className="font-semibold text-violet-700">{suggested.length} new suggestions</span> ready to review.
          </div>
        </div>
      </div>
