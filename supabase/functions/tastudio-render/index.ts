// TA Studio: edit a user-provided car photo with a TECHART-style prompt.
// Returns a base64 data URL of the modified image.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!imageDataUrl || !prompt) {
      return new Response(
        JSON.stringify({ error: "imageDataUrl and prompt are required" }),
    ...
    console.error("tastudio-render error", e);
    return new Response(
